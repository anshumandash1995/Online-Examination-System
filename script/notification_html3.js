...
function getdata(edata,edata2)
{
    notification_html[4] = '<div class="activity-item"> <i class="fa fa-tasks text-warning"></i> <div class="activity"> '+edata+' <span>'+edata2+'</span> </div> </div>';
}