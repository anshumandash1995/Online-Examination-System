...
$adminpass="";
$auth="";
$sql = "select * from oes_login where userid='$adminid'";
      ...
      <ul class="nav navbar-nav">
         ...
         <li class="dropdown">
            ...
            <ul class="dropdown-menu">
               <li><a href="employee.php">Manage Examiner Record</a></li>
        <li><a href="student.php">Manage Student Record</a></li>
        <li><a href="employee.php">Add New Examiner Record</a></li>
        <li><a href="student.php">Add New Student Record</a></li>
            </ul>
         </li>
         <li class="">
